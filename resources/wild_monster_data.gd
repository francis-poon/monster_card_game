...
func to_tamed_monster_data(nickname: String) -> TamedMonsterData:
	return TamedMonsterData.new(monster_id, deck.to_untamed_deck(), name, deck_size,
	starting_hand_size, draw_size, max_health, deck_cost_capacity, card_cost_modifiers,
	nickname, Globals.create_tamed_id())
